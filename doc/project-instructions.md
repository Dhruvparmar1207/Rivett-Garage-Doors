...
`\rivett\Residential-Garage-Doors.php`

as the **MASTER PAGE LAYOUT/TEMPLATE**.

The new page must follow the layout and structure of `Residential-Garage-Doors.php`, including where applicable:
...
**Do not copy the page-specific content from `Residential-Garage-Doors.php` unless specifically requested.**

Use `Residential-Garage-Doors.php` for the **NEW WEBSITE'S LAYOUT**.

Use the reference URL for the **CONTENT**.

Therefore:

**Residential-Garage-Doors.php = PAGE LAYOUT/TEMPLATE**

**Reference website = CONTENT SOURCE**

**Local destination folder = FINAL IMPLEMENTATION**

If the existing `Residential-Garage-Doors.php` layout can be reused directly, reuse its structure/components rather than creating a completely different layout.

If you need to create a new component, it must visually and structurally match the existing `Residential-Garage-Doors.php` page.
