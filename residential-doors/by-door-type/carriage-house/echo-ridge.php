<?php
/**
 * Landmark™ Echo Ridge L138ER — four-section carriage house door with
 * Fibrex® overlay boards.
 *
 ...
 *
 * Two things about this model shape the data below. Its "panel styles"
 * are OVERLAY styles — the arrangement of the boards applied over the
 * steel panel — so the first tab is labelled accordingly. And the boards
 * are finished separately from the door, which is why there is a Board
 * Colours tab that no other model in the range has.
 *
...
$page_title       = 'Echo Ridge L138ER | Carriage House Garage Doors, 1 3/8″ R12 | Rivett Architectural Hardware';
$page_description = 'Classic carriage house garage door styles. The Landmark™ Echo Ridge L138ER is a four-section '
...
/* The overlay board arrangements. These are not pressed panel profiles —
   each is a pattern of Fibrex boards laid over the steel section. */
$overlay_styles = [
...
/* Door colours. The hex values are sampled from the manufacturer's finish
...
<section class="product-page-banner rivett-padding rivett-cmn">
        ...
        <div class="row">
            <div class="col-xxl-5 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 left-side">
                ...
                <div class="product-intro">
                    <h1 class="desktop-heading">Landmark&trade; Echo Ridge L138ER</h1>

                    <h2>Time Honoured Style.</h2>

                    <p>A beautifully crafted door that has a vintage look, that&rsquo;s matched with
                        technologically-advanced durability and strength. The best garage door to add period-charm
                        with authentic-looking decorative hardware and five window insert options.</p>

                    <ul class="product-intro-list">
                        <li>
                            <i class="fa-solid fa-angle-right" aria-hidden="true"></i>
                            <span>1 3/8&Prime; Neufoam&trade; Polyurethane Insulated Carriage House
                                <a href="residential-doors/Residential-Garage-Doors.php">Garage Door</a>
                                (R12).</span>
                        </li>
                        <li>
                            <i class="fa-solid fa-angle-right" aria-hidden="true"></i>
                            <span>Four-Section Door With Carriage House With Fibrex&reg; Overlay Boards.</span>
                        </li>
                        <li>
                            <i class="fa-solid fa-angle-right" aria-hidden="true"></i>
                            <span>9 Colour Options, 2 Overlay Colour Options and 5 Panel Styles Available.</span>
                        </li>
                    </ul>
            ...
            <div class="col-xxl-7 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 right-side">
                <h1 class="mobile-heading">Landmark&trade; Echo Ridge L138ER</h1>
    ...
    <div class="product-gallery-popup mfp-hide" id="productGalleryPopup" role="dialog" aria-modal="true"
        aria-label="Echo Ridge L138ER image gallery" tabindex="-1">
            ...
            <div class="col-xxl-9 col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12 right-side">
                ...
                <div class="rv-tab-panel" id="door-opt-board-colours" role="tabpanel"
                    ...
                    <p class="door-options-note">*The Fibrex&reg; overlay boards are finished separately from the
                        door, so you can contrast them against any of the door colours above.</p>
                </div>
                ...
                <div class="rv-tab-panel" id="door-opt-warranty" role="tabpanel"
                    ...
                    <p>There are enough worries in life &ndash; your garage door shouldn&rsquo;t be one of them.
                        ...
                        Warranty.</p>
                    <p>A door is only as good as its installation, so every Echo Ridge we supply is fitted by
                ...
                <div class="rv-tab-panel" id="door-opt-literature" role="tabpanel"
                    ...
                    <h3>Literature</h3>
                    <p>Download the product literature for the Landmark&trade; Echo Ridge L138ER, or ask us to walk
